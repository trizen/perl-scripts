...
say '(4^64-1)^3 - 1     = ', join ' * ', cgpow_factor(powint(powint(4, 64) - 1, 3) - 1);
...
(4^64-1)^3 - 1     = 2 * 170141183460469231731687303715884105727 * 115792089237316195423570985008687907852929702298719625575994209400481361428481
