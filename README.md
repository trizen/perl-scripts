...
* Encoders
    ...
    * [Delta encoding with double-elias coding](./Encoders/delta_encoding_with_double-elias_coding.pl)
    ...
    * [Double-elias gamma encoding](./Encoders/double-elias_gamma_encoding.pl)
    * [Elias gamma encoding](./Encoders/elias_gamma_encoding.pl)
    ...
    * [Integers binary encoding with delta coding](./Encoders/integers_binary_encoding_with_delta_coding.pl)
    * [Integers binary encoding with huffman coding](./Encoders/integers_binary_encoding_with_huffman_coding.pl)
    * [Length encoder](./Encoders/length_encoder.pl)
    * [Lz77 file compression](./Encoders/lz77_file_compression.pl)
    * [Lzh file compression](./Encoders/lzh_file_compression.pl)
    * [Lzhd file compression](./Encoders/lzhd_file_compression.pl)
    * [Lzih file compression](./Encoders/lzih_file_compression.pl)
    * [Lzss file compression](./Encoders/lzss_file_compression.pl)
    ...
    * [Mrh file compression](./Encoders/mrh_file_compression.pl)
    * [Mtf-delta encoding](./Encoders/mtf-delta_encoding.pl)
